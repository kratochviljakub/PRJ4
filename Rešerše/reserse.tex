...
Přímé metody, oproti významným bodům, zpracovávají vstupní obraz bez použití doplňků extrahujících určité části obrazu. Rozdíl mezi těmito metodami spočívá v použití geometrické konzistence obrazu oproti fotometrické konzistenci u přímých metod.
